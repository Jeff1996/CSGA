...
训练结果: 
    /home/hjf/workspace/mmsegmentation/work_dirs/swin-tiny-patch4-window7-LN_upernet_2xb8-160k_ade20k-512x512/20250106_235009/20250106_235009.log
训练配置: 
    batchsize8, 160k, ade20k, 
    stride(8*8), 
    本架构,使用swin-t预训练权重在ImageNet-1K上训练50epoch
mIoU: 42.35
'''
