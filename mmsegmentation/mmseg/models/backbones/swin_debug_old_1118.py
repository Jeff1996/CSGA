'''
架构说明: swin_debug_old_1118.py
1. 使用下采样的k、v矩阵降低计算复杂度
2. 使用平均池化进行初步下采样，使用soft k-means进行聚类(仅迭代1次)
...
训练结果：
    /home/hjf/workspace/mmsegmentation/work_dirs/swin-tiny-patch4-window7-LN_upernet_4xb2-80k_ade20k-512x512/20241119_163512/20241119_163512.log
    /home/hjf/workspace/mmsegmentation/work_dirs/swin-tiny-patch4-window7-LN_upernet_4xb2-80k_ade20k-512x512/20241120_135346/20241120_135346.log
训练配置: batchsize8, 80k -> 160k, ade20k, swin-t预训练权重 -> 1118架构80k迭代权重
mIoU: 42.79 -> 43.51
'''
