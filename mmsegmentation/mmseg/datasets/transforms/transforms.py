...
# 自定义的标签映射方法, 可在自定义的数据处理pipeline中使用:
# 在mmseg/datasets/pascal_5i.py中, 在加载标注文件后添加: dict(type='CustomLabelMap', label_map={255: 1}),
@TRANSFORMS.register_module()
class CustomLabelMap(BaseTransform):
