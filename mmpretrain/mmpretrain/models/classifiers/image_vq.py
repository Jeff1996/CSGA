...
class ImageClassifierVQ(BaseClassifier):
    ...
    def __init__(self,
        ...
        super(ImageClassifierVQ, self).__init__(
    ...
    def extract_feat(self, inputs, stage='neck'):
        ...
        x, error_quantization = self.backbone(inputs)
    ...
    def loss(self, inputs: torch.Tensor,
        ...
        """
        feats, error_quantization = self.extract_feat(inputs)
