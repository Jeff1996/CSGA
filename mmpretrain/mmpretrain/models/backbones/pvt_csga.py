    ...
    def forward(self, x):
        ...
        for i in range(self.num_stages):
            ...
            if i == 0:  # 仅在第一个stage构造初始聚类分布
                ...
                delta_onehot_x = self.initIndex((H, W), stride=(4, 4), device=x.device).repeat(x.shape[0], 1, 1, 1)
...
class pvt_tinyMod(PyramidVisionTransformer):
    def __init__(
        self, 
        img_size=224, 
        patch_size=4, 
        ...
        **kwargs
        ...
        super(pvt_tinyMod, self).__init__(
            img_size=img_size,
...
@MODELS.register_module()
class pvt_smallMod(PyramidVisionTransformer):
    def __init__(
        self, 
        img_size=224, 
        patch_size=4, 
        ...
        **kwargs
        ...
        super(pvt_smallMod, self).__init__(
            img_size=img_size,
            patch_size=patch_size, 
            embed_dims=embed_dims, 
            num_heads=num_heads, 
...
@MODELS.register_module()
class pvt_mediumMod(PyramidVisionTransformer):
    def __init__(
        self, 
        img_size=224, 
        patch_size=4, 
        ...
        **kwargs
        ...
        super(pvt_mediumMod, self).__init__(
            img_size=img_size,
            patch_size=patch_size, 
            embed_dims=embed_dims, 
            num_heads=num_heads, 
...
@MODELS.register_module()
class pvt_largeMod(PyramidVisionTransformer):
    def __init__(
        self, 
        img_size=224, 
        patch_size=4, 
        ...
        **kwargs
        ...
        super(pvt_largeMod, self).__init__(
            img_size=img_size,
            patch_size=patch_size, 
            embed_dims=embed_dims, 
            num_heads=num_heads, 
